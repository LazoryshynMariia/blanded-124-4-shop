...
`).join(""),L=({id:o,title:t,description:e,category:a,price:n,thumbnail:d,brand:l,shippingInformation:r,returnPolicy:g,tags:_,images:y})=>`
    <img class="modal-product__img" src="${y[0]}" alt="${t}" />
      <div class="modal-product__content">
        <p class="modal-product__title">${t}</p>
        <ul class="modal-product__tags">
        ${_.map(b=>`<li>${b}</li>`).join("")}
        </ul>
